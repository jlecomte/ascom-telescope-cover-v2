...
[Setup]
AppId={{E9C01E46-1989-4CD9-91A3-D135B7E1AF8C}
...
SourceDir="C:\Users\Julien\source\repos\ascom-telescope-cover-v2"
OutputDir="Installer"
...
[Files]
Source: "ASCOM_Driver\bin\Release\ASCOM.DarkSkyGeek.TelescopeCoverV2.dll"; DestDir: "{app}"

[Run]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.TelescopeCoverV2.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.TelescopeCoverV2.dll"""; Flags: runhidden 64bit; Check: IsWin64

[UninstallRun]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.TelescopeCoverV2.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.TelescopeCoverV2.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.TelescopeCoverV2.dll"""; Flags: runhidden 64bit; Check: IsWin64
